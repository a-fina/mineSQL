...
public class Menu {
     ...
     */
    public JSONArray getConnectionTableList(JSONArray connectionDBmenu, String host, String database, String user, String password, String showAllDB, String dbType) 
