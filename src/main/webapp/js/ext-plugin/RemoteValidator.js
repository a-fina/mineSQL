 ...
 * @version   $Id: RemoteValidator.js,v 1.7 2009/01/28 09:35:04 assioma Exp $
 */
...
Ext.ux.plugins.RemoteValidator = {
	init:function(field) {
        ...
        debug("Ext.ux.plugins.RemoteValidator : " + remoteValidDefault);
		// apply remote validation to field
		Ext.apply(field, {
			 remoteValid: remoteValidDefault
