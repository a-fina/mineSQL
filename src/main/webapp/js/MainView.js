...
function runReportRequest(params){
        ...
        Ext.Ajax.request({
            ...
            failure : function (){ Ext.MessageBox.alert("Errore di caricamento" ); },
            /*headers : {
...
Ext.onReady(function(){
    ...
    /*
    * Menu per visualizzare i grafici
    */  
    var databaseMenu = new GenericMenu({
        id: "databaseMenu", 
        ...
        items:[
            {
                ...
                margins:'0 0 0 0',
                listeners: {
            		'collapse': function() {Ext.getCmp('viewport').fireEvent('resize');},
            		'expand': function() {Ext.getCmp('viewport').fireEvent('resize');}
                }
            },{
                region:'center',
                contentEl: 'corpo',
                ...
                tbar : [{
                        text:'Users admin',
                        handler: function(){ viewUsersToAble(''); },
                    ...
                    *********/
                    ...
                    '-',
                    {
                        ...
                        menu: { items:[{
                                    ...
                                    {text:'Host:&nbsp;<font color="#000000"><b>'+ HOST_NAME +'</b></font>&nbsp;', handler: function(){}},
                                    {text:'User:&nbsp;<font color="#000000"><b>'+ USER_NAME +'</b></font>&nbsp;', handler: function(){}},
                                    {text:'Reparto:&nbsp;<font color="#000000"><b>'+ USER_NOME_REPARTO+'</b></font>&nbsp;', handler: function(){}},
                                    {text:'Ruolo:&nbsp;<font color="#000000"><b>'+ USER_NOME_RUOLO+'</b></font>&nbsp;', handler: function(){}}
                                ]
                        }
                    },
                    '-',
