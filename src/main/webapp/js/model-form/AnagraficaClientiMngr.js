 ...
 * @date      30 / 04 / 09
 * @version   0.1
 * @revision  $Id: AnagraficaClientiMngr.js,v 1.4 2009/08/03 15:30:54 assioma Exp $
 *
	...
	var defaults = {
               items: new Ext.form.FieldSet({
                ...
                submitParams: {
                        ...
                        'tableName': 'report',
                        'entityName': 'AnagraficaClienti'
                },
                title: 'Salva Nuovo CLiente', 
                tableName: 'AnagraficaClienti',
                crud: 'create',
                modal: true,
 ...
 */
AnagraficaClientiMngr.deleteWin = function(config) {
	var defaults = {
               items: new Ext.form.FieldSet({
 ...
 */
AnagraficaClientiMngr.updateWin = function(config) {
	var defaults = {
               items: new Ext.form.FieldSet({
                    title: 'Informationi Filtro',
                    autoHeight: true,
