 ...
 * @date      30 / 04 / 09
 * @version   0.1
 * @revision  $Id: TimesheetMngr.js,v 1.4 2009/08/03 15:30:54 assioma Exp $
 *
 ...
 */
TimesheetMngr.saveWin = function(config) {
 ...
 */
TimesheetMngr.deleteWin = function(config) {
	var defaults = {
               items: new Ext.form.FieldSet({
 ...
 */
TimesheetMngr.updateWin = function(config) {
	var defaults = {
               items: new Ext.form.FieldSet({
